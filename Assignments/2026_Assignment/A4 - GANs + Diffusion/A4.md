...
![GAN Training Flow](img/gan_training_flow.png)
...
![GAN Architecture](img/gan_diagram.png)
...
![Mode Collapse Example](img/mode_collapse.png)
...
![Paired vs Unpaired Training](img/cyclegan_paired_vs_unpaired.png)
...
![CycleGAN Two-Cycle Architecture](img/cyclegan_cycle_diagram.png)
...
![CycleGAN Generator Architecture](img/cyclegan_generator_arch.png)
...
![PatchGAN vs Global Discriminator](img/patchgan_vs_global.png)
...
> "We split CelebA into dark-hair (Domain X) and blonde-hair (Domain Y) based on the Blond_Hair attribute. 5,000 images each. The CycleGAN learns to swap hair color without any paired examples — it never sees a person with both dark and blonde hair."

![CycleGAN Real-World Results](img/cyclegan_teaser.jpg)
